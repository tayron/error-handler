...
{	
	...
	{
		$formatedMessage = sprintf($this->template, $messageErro, $fileName, $fileLine, $this->getErrorDescription($errorLevel));
	...
	public function setError() 
	{
		...
		if(is_array($error)){
			$formatedMessage = sprintf($this->template, $error['message'], $error['file'], $error['line'], $this->getErrorDescription($error['type']));
	...
	{
		return (isset($this->errorList[$errorLevel])) 
			? $this->errorList[$errorLevel] : $errorLevel ;
	}
}